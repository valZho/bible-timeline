...
const eventData4 = () => {
  const events = {
    ...
    solomonReign: { relative: { id: 'temple1start', start: -4 }, years: 40, exact: true, color: 'grape.5' },

    // JUDAH (SOUTHERN KINGDOM) need solomon in there for reference
    rehoboam: { relative: { id: 'solomonReign', end: 0 }, color: 'grape.5', years: 17 },
    abijam: { relative: { id: 'jeroboam1', start: 18 }, color: 'grape.5', years: 3 },
    asa: { relative: { id: 'jeroboam1', start: 20 }, color: 'grape.5', years: 41 },
    jehoshaphat: { relative: { id: 'ahab', start: 4 }, color: 'grape.5', years: 25 },
    jehoram: { relative: { id: 'joram', start: 5 }, color: 'grape.5', years: 8 },
    ahaziahSouth: { relative: { id: 'joram', start: 12 }, color: 'grape.5', years: 1 },
    athaliah: { relative: { id: 'ahaziahSouth', end: 0 }, color: 'grape.5', years: 6 },
    joash: { relative: { id: 'athaliah', end: 0 }, color: 'grape.5', years: 40 },
    amaziah: { relative: { id: 'jehoash', start: 2 }, color: 'grape.5', years: 29 },
    uzziah: { relative: { id: 'jeroboam2', start: 27 }, color: 'grape.5', years: 52 },
    jotham: { relative: { id: 'pekah', start: 2 }, color: 'grape.5', years: 16 },
    ahaz: { relative: { id: 'pekah', start: 17 }, color: 'grape.5', years: 16 },
    hezekiah: { relative: { id: 'hoshea', start: 3 }, color: 'grape.5', years: 29 },
    manasseh: { relative: { id: 'hezekiah', end: 0 }, color: 'grape.5', years: 55 },
    amon: { relative: { id: 'manasseh', end: 0 }, color: 'grape.5', years: 2 },
    josiah: { relative: { id: 'amon', end: 0 }, color: 'grape.5', years: 31 },
    jehoahazSouth: { relative: { id: 'josiah', end: 0 }, color: 'grape.5', years: 0.25, exact: true },
    jehoiakim: { relative: { id: 'jehoahazSouth', end: 0 }, color: 'grape.5', years: 11, exact: true },
    jehoiachin: { relative: { id: 'jehoiakim', end: 0 }, color: 'grape.5', years: 0.25, exact: true },
    zedekiah: { relative: { id: 'jehoiachin', end: 0 }, color: 'grape.5', years: 11 },

    // ISRAEL (NORTHERN KINGDOM)
    jeroboam1: { relative: { id: 'solomonReign', end: 0 }, color: 'violet.6', years: 22 },
  ...
  events.saulReign = { relative: { id: 'davidReign', start: -40 }, years: 40, exact: true, color: 'grape.5' };

  events.david = { relative: { id: 'davidReign', start: -30 }, years: 70.5 };
  events.davidReign = { relative: { id: 'solomonReign', start: -40.5 }, years: 40.5, exact: true, color: 'grape.5' };
